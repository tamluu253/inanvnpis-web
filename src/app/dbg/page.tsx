...
export default async function AnalyticsDashboard(props: {
  ...
  return (
    <html lang="vi">
      <head>
        <title>INANVNPIS.COM Analytics Dashboard - Thực tế</title>
        ...
        <div style={{ padding: '24px', maxWidth: '1280px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', borderBottom: '1px solid #1e293b', paddingBottom: '16px' }}>
            <div>
              ...
              <h1 style={{ fontSize: '24px', fontWeight: 'bold', color: '#f59e0b', margin: '8px 0 0 0' }}>INANVNPIS.COM &mdash; ANALYTICS DASHBOARD</h1>
                      ...
                      return (
                        <tr key={kw.rank} style={{ borderBottom: '1px solid #334155' }}>
                          ...
                          <td style={{ padding: '10px' }}>
                            <span style={{ backgroundColor: insight.bg, color: insight.color }} className="px-2 py-1 rounded text-[10px] font-extrabold inline-block">
                              {insight.label}
                            </span>
                          </td>
                        </tr>
                      ...
                      <tr>
                        <td colSpan={6} style={{ padding: '24px', textAlign: 'center', color: '#f87171', fontSize: '13px', lineHeight: '1.6' }}>
                          {gscError ? (
                            ...
                            'Chưa có dữ liệu từ khóa hiển thị trong khoảng thời gian này.'
                          )}
                        </td>
                      </tr>
                    )}
