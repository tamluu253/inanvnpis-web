      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="text-center bg-gradient-to-r from-teal-600 to-emerald-600 text-white p-10 rounded-3xl shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="https://zalo.me/0987453866" target="_blank" rel="noreferrer" className="inline-flex items-center px-6 py-3.5 bg-white text-teal-700 hover:bg-slate-100 font-bold rounded-2xl shadow-lg transition-colors text-sm">
              <Phone className="w-4 h-4 mr-2" /> Zalo Mr. Tâm: 0987 453 866
            </a>
            <a href="https://zalo.me/0987453866" target="_blank" rel="noreferrer" className="inline-flex items-center px-6 py-3.5 bg-teal-900 text-white hover:bg-teal-950 font-bold rounded-2xl shadow-lg transition-colors text-sm">
              <Phone className="w-4 h-4 mr-2" /> Zalo Mr. Tâm: 0987 453 866
            </a>
          </div>
        </div>
